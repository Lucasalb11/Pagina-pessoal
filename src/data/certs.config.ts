...
export const CERTS: Cert[] = [
  ...
  {
    credentialId: "solana-house-sp",
    name: "Solana House São Paulo",
    program: "Builder Events",
    issuer: "Solana Foundation",
    dateIssued: "2024",
    ecosystem: "Solana",
    icon: Award,
    description: "Builder participation at Solana House São Paulo — hands-on workshops and ecosystem programming.",
    verifyUrl: "https://solana.com",
    mintAddress: "HgKdLH288AzmtMKH6BoxrKBEfxaNa2BWtnfVz3zuNnk7",
    status: "MINTED",
    attest: "self",
    attributes: [
      { trait_type: "Event",  value: "Solana House SP" },
      { trait_type: "Format", value: "In-person builder programming" },
    ],
  },
  {

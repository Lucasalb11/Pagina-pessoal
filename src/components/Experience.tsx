...
const EXPERIENCE = [
  {
    icon:        TrendingUp,
    company:     "Independent",
    role:        "DeFi Researcher & Investor",
    period:      "2023 — Present",
    location:    "Remote",
    type:        "Current",
    typeColor:   "accent",
    description:
      "Researching and applying DeFi strategies across Ethereum, Solana, Stellar, and Base networks. Analyzing whitepapers, governance forums, and on-chain data. Developing smart contracts and contributing to open-source Web3 projects.",
    highlights: [
      "Active on 4 blockchain ecosystems — Ethereum, Solana, Stellar, Base",
      "Informal mentorship to peers on DeFi onboarding and portfolio structuring",
      "Whitepaper analysis and protocol governance participation",
      "22+ open-source repositories on GitHub",
    ],
  },
  {
    icon:        Building2,
    ...
    typeColor:   "primary",
    description:
      "Co-founded and directed a construction company from inception through scale. Built and managed multidisciplinary teams, secured institutional financing, and oversaw the full lifecycle of large real estate developments.",
    highlights: [
      "Orchestrated 12 simultaneous construction projects",
      "Led a workforce of 100+ employees and multidisciplinary teams",
      "Secured institutional financing through Caixa Econômica Federal",
      "Developed comprehensive economic feasibility plans for high-value properties",
    ],
  },
];
        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="flex items-end gap-6 mb-16 relative">
            ...
            <div className="relative z-10">
              <div className="flex items-center gap-3 mb-3">
                ...
                <span className="font-mono text-xs text-primary tracking-[0.2em] uppercase">Experience</span>
              </div>
          ...
          <div className="mt-10 p-6 rounded-xl bg-primary/5 border border-primary/20 flex flex-col sm:flex-row items-start sm:items-center gap-4">
            <div className="flex-1 space-y-1">
              <p className="font-semibold text-foreground">The unique combination</p>
              <p className="text-sm text-muted-foreground">
                7 years running a 100-person company means I don't just write code — I understand
                incentives, risk, capital flows, and what it takes to deliver at scale.
                That mindset shapes every protocol I build.
              </p>
            </div>
            <a
